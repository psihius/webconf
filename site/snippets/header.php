...
<header class="siteHeader js-siteHeader">
  ...
  <nav class="siteHeader__mainnav nav--mainnav">
    ...
    <div role="navigation" class="nav--mainnav__list js-mainnavList"><a href="#hero" class="nav--mainnav__item--logo js-mainnavItem"><img src="assets/images/logo.svg"/></a><? foreach($pages->visible()->not(array('hero','tickets','past')) as $section): ?><a href="#<?= $section->uid() ?>" class="nav--mainnav__item js-mainnavItem"><?= $section->title() ?></a><? endforeach ?>
