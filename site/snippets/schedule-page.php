      ...
      <table class="t schedule">
        ...
        <tbody class="t-body"><? foreach($afterparty as $line): ?>
          <tr class="t-body__tr">
            ...
            <td class="t-body__td">
              <? if($line["type"] == "speach"): ?>
              <?= print_r($line) ?><span class="schedule__speach"><?= $line["title"] ?></span><span class="schedule__desc"><?= $line["desc"] ?></span><span class="schedule__speaker"><?= $line["speaker"] ?></span><? else: ?><span class="schedule__action"><?= $line["title"] ?></span><? endif ?>
            </td>
          </tr><? endforeach ?>
        </tbody>
      </table><? endif ?>
      ...
      <table class="t schedule">
        ...
        <tbody class="t-body"><? foreach($day2 as $line): ?>
          <tr class="t-body__tr">
            ...
            <td class="t-body__td"><? if($line["type"] == "speach"): ?><span class="schedule__speach"><?= $line["title"] ?></span><span class="schedule__desc"><?= $line["desc"] ?></span><span class="schedule__speaker"><?= $line["speaker"] ?></span><? else: ?><span class="schedule__action"><?= $line["title"] ?></span><? endif ?>
            </td>
          </tr><? endforeach ?>
        </tbody>
      </table><? endif ?>
